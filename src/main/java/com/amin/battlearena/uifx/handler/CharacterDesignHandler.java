...
public class CharacterDesignHandler {
    ...
    private void createWarriorDesign(StackPane parent, Circle base, Character character) {
    ...
    private void createArcherDesign(StackPane parent, Circle base, Character character) {
    ...
    private void createMageDesign(StackPane parent, Circle base, Character character) {
    ...
    private void createKnightDesign(StackPane parent, Circle base, Character character) {
    ...
    private void createRangerDesign(StackPane parent, Circle base, Character character) {
    ...
    private void createGenericDesign(StackPane parent, Circle base, Character character) {
